...
/***/ "./resources/js/datatable/language.js":
/*!********************************************!*\
  !*** ./resources/js/datatable/language.js ***!
  \********************************************/
...
/* harmony export */ });
var helper = __webpack_require__(/*! ../helper */ "./resources/js/helper.js");

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  sLengthMenu: "".concat(helper.trans("common.general.show"), "&nbsp;\n        <select>\n            <option value=\"10\">10</option>\n            <option value=\"25\">25</option>\n            <option value=\"50\">50</option>\n            <option value=\"100\">100</option>\n        </select>&nbsp;\n        ").concat(helper.trans("common.general.records")),
  sSearch: "",
  ...
  sInfo: "".concat(helper.trans("common.general.show"), " ").concat(helper.trans("common.general.from"), " _START_ ").concat(helper.trans("common.general.to"), " _END_ ").concat(helper.trans("common.general.of"), " _TOTAL_ ").concat(helper.trans("common.general.records")),
  sEmptyTable: "<div id=\"request-table-inner\">\n                        <div class=\"p-5 text-center\">\n                            <h3>".concat(helper.trans("common.general.noData"), "</h3>\n                        </div>\n                    </div>"),
  sZeroRecords: helper.trans("common.general.noMatching"),
  sInfoEmpty: helper.trans("common.general.noData"),
  sInfoFiltered: "".concat(helper.trans("common.general.from"), " _MAX_ ").concat(helper.trans("common.general.records"))
});
...
function showToast(content, timeout) {
  ...
  switch (type) {
    ...
    case 'error':
      toastr__WEBPACK_IMPORTED_MODULE_0___default().error(content);
      break;

    case 'warning':
      toastr__WEBPACK_IMPORTED_MODULE_0___default().warning(content);
      break;
  }
}
...
/* harmony import */ var _datatable_language__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./datatable/language */ "./resources/js/datatable/language.js");
...
$(document).ready(function () {
  ...
  $("#selectAll").change(function (e) {
    var allCheckbox = $(document).find('input[type="checkbox"]');
    ...
    if ($(this).checked) {
      ...
      if (checkboxsBlock.length) {
        $(".amount_active").empty().text("(".concat(checkboxsBlock.length, ")"));
        $("#active_user").attr("disabled", false);
      }

      if (checkboxsActive.length) {
        $(".amount_block").empty().text("(".concat(checkboxsActive.length, ")"));
  ...
  $(document).on("click", ".block_user", function (e) {
    ...
    $.ajax({
      type: "PATCH",
      url: _routes__WEBPACK_IMPORTED_MODULE_2__["default"].users.blockUser,
      data: {
        id: id
      }
    }).done(function (result) {
      $(".statusUser-".concat(id)).empty().append("<button data-id=\"".concat(id, "\"\n                class=\"active_user cursor-pointer inline-flex justify-center py-1 px-3 border border-transparent shadow-sm text-xs font-bold rounded-md text-white bg-green-500 focus:outline-none focus:ring-0 focus:ring-offset-0\">\n                    ").concat(helper.trans("user.active"), "\n                    <span class=\"amount_active\"></span>\n                </button>"));
      helper.showToast(helper.trans("common.success.update"), 3000, "success");
    }).fail(function (errors) {
      helper.showToast(helper.trans("common.general.wrong"), 3000, "error");
    });
  });
  ...
  $("#btn-checkout").click(function (e) {
    ...
    var data = $("#form-checkout").serializeArray();
    $.ajax({
      type: "POST",
      url: _routes__WEBPACK_IMPORTED_MODULE_2__["default"].users.order,
      data: data
    }).done(function (result) {
      helper.showToast(helper.trans("common.success.update"), 1500, "success");
    }).fail(function (errors) {
  ...
  new $.fn.dataTable.FixedColumns($("#manage-users").DataTable({
    scrollY: "500px",
    scrollCollapse: true,
    paging: true,
    fixedColumns: true,
    oLanguage: _datatable_language__WEBPACK_IMPORTED_MODULE_1__["default"]
  }));
});
})();
