{{-- <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-gray-800 border-r dark:bg-gray-800 dark:border-gray-600">
        ...
        <h2 class="uppercase text-center text-3xl font-semibold text-white dark:text-white">
            {{ Auth::user()->name }}
        </h2>
